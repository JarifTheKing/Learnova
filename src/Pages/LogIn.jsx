...
const LogIn = () => {
  ...
  return (
    <Container>
      <div className="my-4">
        <div className="min-h-screen bg-[url('/Brail.jpg')] bg-black/50 bg-blend-overlay bg-cover bg-center bg-no-repeat rounded-3xl flex items-center justify-center px-4 sm:px-6 md:px-8">
